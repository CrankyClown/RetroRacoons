...
interface LAIZYLIONSInterface extends ethers.utils.Interface {
  functions: {
    ...
    "tokenURISuffix()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "tokenURISuffix",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class LAIZYLIONS extends BaseContract {
  ...
  functions: {
    ...
    tokenURISuffix(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    tokenURISuffix(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    tokenURISuffix(overrides?: CallOverrides): Promise<PopulatedTransaction>;
